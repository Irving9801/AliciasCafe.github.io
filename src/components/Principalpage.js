...
import { Carousel, Col, Image, Row, Button, Radio } from "antd";
...
const Principalpage = () => {
  ...
  return (
    <section style={{ margin: 10 }}>
      <div>
        <hr></hr>
        <p id="paginaprincipal" style={{ margin: 20, padding: 20 }}>
          ¡Amamos la comida deliciosa!
        </p>
        <br></br>
        <div>
        ...
        <a href="#">
          <Button style={{ margin: 20 }} type="danger">
            {" "}
            Explorar Menú
          </Button>
        </a>
        ...
        <div>
          ...
          <Row gutter={[8, 8]} style={{ width: "80%", margin: "auto" }}>
            <Col span={12}>
              ...
              turn around and return to its own, safe country. A small river
